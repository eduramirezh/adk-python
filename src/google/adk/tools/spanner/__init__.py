...
2. We want to provide more high-level tools like Vector Search, Full text
search, ML.Predict, and Graph etc.
...
4. We want to provide Spanner best practices and knowledge assistants for both
ad-hoc analytics queries and observability tools.
