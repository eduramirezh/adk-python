...
class Runner:
  ...
  async def run_async(
    ...
    # aclose allows to correctly close span context in async generator.
    # https://github.com/google/adk-python/issues/1670#issuecomment-3115891100.
    agen = run_with_trace(new_message)
    try:
