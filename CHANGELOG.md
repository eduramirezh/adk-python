...
* Implement Live Session Resumption ([71fbc92](https://github.com/google/adk-python/commit/71fbc9275b3d74700ec410cb4155ba0cb18580b7))
* Support parallel execution of parallel function calls ([57cd41f](https://github.com/google/adk-python/commit/57cd41f424b469fb834bb8f2777b5f7be9aa6cdf))
* Allow max tokens to be customizable in Claude ([7556ebc](https://github.com/google/adk-python/commit/7556ebc76abd3c776922c2803aed831661cf7f82))
* Add `BaseAgent.config_type` field to indicate the config for the current agent ([2bb2041](https://github.com/google/adk-python/commit/2bb20411f4909685d42784ec17e6c77813571262))
* Add GenerateContentConfig to LlmAgentConfig ([9656ccc](https://github.com/google/adk-python/commit/9656ccc4075df17d8f6835927cd7560e12980500))
* create enterprise_web_search_tool as a tool instance ([0e28d64](https://github.com/google/adk-python/commit/0e28d64712e481cfd3b964be0166f529657024f6))
...
* Using async lock for accessing shared object in parallel executions ([6da6c2a](https://github.com/google/adk-python/commit/6da6c2a44cf1f8b9225487a711c3e6094ca5355f))
* Correct type annotation ([97318bc](https://github.com/google/adk-python/commit/97318bcd199acdacadfe8664da3fbfc3c806cdd2))
* Typo again in `adk run --replay` help ([e369c28](https://github.com/google/adk-python/commit/e369c283b3ac47282207fd6940ac2d249fe04463))
* Fix adk deploy cloud_run cli ([e41dbcc](https://github.com/google/adk-python/commit/e41dbccf7f610e249108f9321f60f71fe2cc10f4))
* Remove thoughts from contents in llm requests ([d620bcb](https://github.com/google/adk-python/commit/d620bcb384d3068228ea2059fb70274e68e69682))
...
* Fixes adk cli options and method parameters mismatching ([8ef2177](https://github.com/google/adk-python/commit/8ef2177658fbfc74b1a74b0c3ea8150bae866796))
